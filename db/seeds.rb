...
Category.create(name:"전체",uplevel_id:0)
	uplevel=Category.create(name:"패션/의류")
		uplevel2=Category.create(name:"여성 의류/패션",uplevel_id:uplevel.id)
		...
		uplevel2=Category.create(name:"남성 의류/패션",uplevel_id:uplevel.id)
			Category.create(name:"상의",uplevel_id:uplevel2.id)
			Category.create(name:"하의",uplevel_id:uplevel2.id)
			Category.create(name:"자켓/코트/점퍼",uplevel_id:uplevel2.id)
		...
		uplevel2=Category.create(name:"언더웨어/잠옷/내의",uplevel_id:uplevel.id)

		uplevel2=Category.create(name:"기타",uplevel_id:uplevel.id)

	uplevel=Category.create(name:"패션잡화/화장품/헤어")
		uplevel2=Category.create(name:"여성화/남성화/패션화",uplevel_id:uplevel.id)
		...
		uplevel2=Category.create(name:"패션잡화",uplevel_id:uplevel.id)
		...
		uplevel2=Category.create(name:"화장품/향수/바디/헤어",uplevel_id:uplevel.id)
	...
	uplevel=Category.create(name:"유아동/출산/식품")
		uplevel2=Category.create(name:"유아동",uplevel_id:uplevel.id)
		...
		uplevel2=Category.create(name:"임부/출산",uplevel_id:uplevel.id)
		...
		uplevel2=Category.create(name:"식품",uplevel_id:uplevel.id)
	...
	uplevel=Category.create(name:"가구/리빙/건강")
		uplevel2=Category.create(name:"가구/DIY",uplevel_id:uplevel.id)
		...
		uplevel2=Category.create(name:"침구/인테리어/리빙",uplevel_id:uplevel.id)
	...
	uplevel=Category.create(name:"스포츠/자동차")
		uplevel2=Category.create(name:"스포츠/레저",uplevel_id:uplevel.id)
		...
		uplevel2=Category.create(name:"자동차/모터싸이클",uplevel_id:uplevel.id)
	...
	uplevel=Category.create(name:"컴퓨터/디지털/가전")
		uplevel2=Category.create(name:"컴퓨터",uplevel_id:uplevel.id)
		...
		uplevel2=Category.create(name:"디지털",uplevel_id:uplevel.id)
		...
		uplevel2=Category.create(name:"TV/냉장고/세탁기",uplevel_id:uplevel.id)
	...
	uplevel=Category.create(name:"도서/문구/여행/쿠폰")
		uplevel2=Category.create(name:"도서/티켓/쿠폰/상품권",uplevel_id:uplevel.id)
			...
			Category.create(name:"기타",uplevel_id:uplevel2.id)
		uplevel2=Category.create(name:"문구/애완/꽃/악기",uplevel_id:uplevel.id)
